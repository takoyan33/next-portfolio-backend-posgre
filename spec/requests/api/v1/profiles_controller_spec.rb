...
RSpec.describe "Api::V1::profiles", type: :request do
  ...
  #       expect {
  #         post "/api/v1/profiles", params: { job: valid_attributes }
  ...
  #       expect {
  #         post "/api/v1/profiles", params: { job: invalid_attributes }
  ...
  #       put "/api/v1/profiles/#{job_id}", params: { job: valid_attributes }
  #       expect(response).to have_http_status(:success)
  ...
  #       put "/api/v1/profiles/#{job_id}", params: { job: invalid_attributes }
  #       expect(response).to have_http_status(:success)
  #       expect(JSON.parse(response.body)['data']).not_to be_empty
  #     end
  #   end
